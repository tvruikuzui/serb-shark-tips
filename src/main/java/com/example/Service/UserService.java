...
//    private SignalsDao signalsDao;
    ...
    public String AddDaysToUser(String mail, String pass, String user, int days, boolean paid, boolean add) {
        return usersDao.AddDaysToUser(mail, pass, user, days, paid, add) ? "added" : "error";
    }
    ...
    private void sendNotification(String message, List<String> allTokens) {
        ...
        JSONArray ja = new JSONArray(allTokens);

        body.put("registration_ids", ja);
